<script>
    ...
    import { audioPlayer, status, isPlaying, index, thisNextTrack, currentPlaylist } from '$lib/store2.js';
    import { getPlaylistByName } from '$lib/store2';
  ...
  onMount(() => {
        ...
        if ($thisNextTrack !== null || $thisNextTrack === 0) {
            // Charge la piste
  ...
  function playNext() {
    ...
    // Modifiez playPrevious de la même manière
